    ...
    <MobileShell>
      ...
      <section className="glass-panel p-4">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            <p className="text-sm font-semibold">Primary wallet</p>
            <p className="text-xs text-slate-400">Manage balances and movement lifecycle</p>
          </div>
        ...
        <div className="mt-3 grid gap-2 sm:grid-cols-4">
          <div className="metric-card"><p className="text-xs text-slate-400">Available</p><p className="mt-1 text-lg font-semibold">{uiWallets[0]?.balances.available ?? 0}</p></div>
          <div className="metric-card"><p className="text-xs text-slate-400">Held</p><p className="mt-1 text-lg font-semibold">{uiWallets[0]?.balances.held ?? 0}</p></div>
          <div className="metric-card"><p className="text-xs text-slate-400">Pending</p><p className="mt-1 text-lg font-semibold">{uiWallets[0]?.balances.pending ?? 0}</p></div>
          <div className="metric-card"><p className="text-xs text-slate-400">Total</p><p className="mt-1 text-lg font-semibold">{uiWallets[0]?.balances.total ?? 0}</p></div>
        </div>
      </section>
      ...
      <section className="mt-4 grid gap-4 lg:grid-cols-2">
        <article className="glass-panel p-4">
          <h2 className="text-sm font-semibold">Deposit addresses</h2>
        ...
        <article className="glass-panel p-4">
          <h2 className="text-sm font-semibold">Recent deposits</h2>
          <div className="mt-3 space-y-2 text-xs">
      ...
      <section className="glass-panel mt-4 p-4 pb-safe">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          <button className="rounded-lg bg-emerald-400 py-3 text-sm font-semibold text-black">Deposit</button>
          <button className="rounded-lg border border-slate-700 bg-slate-900 py-3 text-sm">Withdraw</button>
        </div>
      </section>
    </MobileShell>
  );
